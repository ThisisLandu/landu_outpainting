...
class Landu_ImpactWildcardEncode:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
# class Landu_Ultimate_SD_Upscale:
#     @classmethod
#     def INPUT_TYPES(cls):
#         return {}
#     RETURN_TYPES = ()
...
# class Landu_DetailerDebug_Segs:
#     @classmethod
#     def INPUT_TYPES(cls):
#         return {}
#     RETURN_TYPES = ()
